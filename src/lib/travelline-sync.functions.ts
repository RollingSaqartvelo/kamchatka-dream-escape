...
async function fetchReservations(
  ...
  const attempts: Array<{ url: string; method: "GET" | "POST"; body?: string }> = [
    {
      url: `${TL_API}/api/reservation/v1/properties/${propertyId}/bookings?dateFrom=${from}&dateTo=${to}`,
      method: "GET",
    },
    {
      url: `${TL_API}/api/reservation/v1/properties/${propertyId}/bookings?from=${from}&to=${to}`,
      method: "GET",
    },
    {
      url: `${TL_API}/api/reservation/v1/properties/${propertyId}/bookings?arrivalFrom=${from}&arrivalTo=${to}`,
      method: "GET",
    },
    {
      url: `${TL_API}/api/reservation/v1/properties/${propertyId}/bookings?checkInFrom=${from}&checkInTo=${to}`,
      method: "GET",
    },
    {
