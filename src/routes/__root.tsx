...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Отель «Полуостров» — гостиница на Камчатке" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Отель «Полуостров» — гостиница на Камчатке" },
      ...
      { name: "twitter:title", content: "Отель «Полуостров» — гостиница на Камчатке" },
